...
impl SemanticColor {
    pub fn light() -> Self {
        Self {
            surface: Color::from_hex("#f5f5f5").expect("valid built-in hex constant"),
            surface_variant: Color::from_hex("#efefef").expect("valid built-in hex constant"),
            surface_inverse: Color::from_hex("#1a1a1a").expect("valid built-in hex constant"),
            background: Color::from_hex("#ffffff").expect("valid built-in hex constant"),
            background_secondary: Color::from_hex("#f9f9f9").expect("valid built-in hex constant"),
            foreground: Color::from_hex("#1a1a1a").expect("valid built-in hex constant"),
            foreground_secondary: Color::from_hex("#616161").expect("valid built-in hex constant"),
            foreground_tertiary: Color::from_hex("#9e9e9e").expect("valid built-in hex constant"),
            foreground_inverse: Color::from_hex("#ffffff").expect("valid built-in hex constant"),
            primary: Color::from_hex("#0066cc").expect("valid built-in hex constant"),
            secondary: Color::from_hex("#6200ee").expect("valid built-in hex constant"),
            accent: Color::from_hex("#ff4081").expect("valid built-in hex constant"),
            success: Color::from_hex("#4caf50").expect("valid built-in hex constant"),
            warning: Color::from_hex("#ffc107").expect("valid built-in hex constant"),
            error: Color::from_hex("#f44336").expect("valid built-in hex constant"),
            info: Color::from_hex("#2196f3").expect("valid built-in hex constant"),
            outline: Color::from_hex("#e0e0e0").expect("valid built-in hex constant"),
        }
    }
    ...
    pub fn dark() -> Self {
        Self {
            ...
            surface_variant: Color::from_hex("#2a2a2a").expect("valid built-in hex constant"),
            surface_inverse: Color::from_hex("#f5f5f5").expect("valid built-in hex constant"),
            background: Color::from_hex("#121212").expect("valid built-in hex constant"),
            background_secondary: Color::from_hex("#1a1a1a").expect("valid built-in hex constant"),
            foreground: Color::from_hex("#f5f5f5").expect("valid built-in hex constant"),
            foreground_secondary: Color::from_hex("#b3b3b3").expect("valid built-in hex constant"),
            foreground_tertiary: Color::from_hex("#757575").expect("valid built-in hex constant"),
            foreground_inverse: Color::from_hex("#1a1a1a").expect("valid built-in hex constant"),
            ...
            warning: Color::from_hex("#ffca28").expect("valid built-in hex constant"),
            error: Color::from_hex("#ef5350").expect("valid built-in hex constant"),
            info: Color::from_hex("#64b5f6").expect("valid built-in hex constant"),
            outline: Color::from_hex("#424242").expect("valid built-in hex constant"),
        }
    }
    ...
    pub fn oled() -> Self {
        Self {
            ...
            background_secondary: Color::from_hex("#0d0d0d").expect("valid built-in hex constant"),
            foreground: Color::from_hex("#f5f5f5").expect("valid built-in hex constant"),
            foreground_secondary: Color::from_hex("#b3b3b3").expect("valid built-in hex constant"),
            foreground_tertiary: Color::from_hex("#757575").expect("valid built-in hex constant"),
            foreground_inverse: Color::from_hex("#000000").expect("valid built-in hex constant"),
            primary: Color::from_hex("#6eb7ff").expect("valid built-in hex constant"),
            secondary: Color::from_hex("#c5b3ff").expect("valid built-in hex constant"),
            accent: Color::from_hex("#ff80ab").expect("valid built-in hex constant"),
            success: Color::from_hex("#81c784").expect("valid built-in hex constant"),
            ...
            error: Color::from_hex("#ef5350").expect("valid built-in hex constant"),
            info: Color::from_hex("#64b5f6").expect("valid built-in hex constant"),
            outline: Color::from_hex("#333333").expect("valid built-in hex constant"),
        }
    }
    ...
    pub fn hdr() -> Self {
        Self {
            ...
            foreground_tertiary: Color::from_hex("#9e9e9e").expect("valid built-in hex constant"),
            foreground_inverse: Color::from_hex("#121212").expect("valid built-in hex constant"),
            primary: Color::from_hex("#6eb7ff").expect("valid built-in hex constant"),
            secondary: Color::from_hex("#c5b3ff").expect("valid built-in hex constant"),
            accent: Color::from_hex("#ff80ab").expect("valid built-in hex constant"),
            success: Color::from_hex("#81c784").expect("valid built-in hex constant"),
